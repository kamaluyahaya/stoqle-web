                                ...
                                <div className="flex justify-center gap-3">
                                    {[0, 1, 2, 3].map((i) => (
                                        <input
                                            ...
                                            className="w-14 h-16 bg-slate-50 border-2 border-slate-100 focus:border-red-500/20 focus:bg-white rounded-2xl text-center text-3xl font-black text-slate-900 transition-all outline-none"
                                        />
                                    ))}
                                </div>
