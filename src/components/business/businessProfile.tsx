...
export default function EditBusinessProfile({
  ...
  const {
    // state
    name, shipping, refunds, payment, customerService, address, market, promo, discount, isLoading, isSyncing, modalOpen, modalProps, hasAnyFilledField,
    // actions
    openEditor, setModalOpen, saveEditorValue, saveProfile,
      ...
      <div className="max-w-7xl mx-auto px-1 pt-2 space-y-4">
        ...
        <div className="mt-6 space-y-4">
          <div className="bg-white rounded-xl shadow-sm">
            <div onClick={() => openEditor("Shipping info", KEYS.shipping, shipping)} className="px-4 py-3 cursor-pointer flex items-center">
              <div className="flex-1">
                <div className="text-sm text-slate-800 font-medium">Shipping info</div>
                <div className="text-sm mt-1">{shipping ? <span className="text-emerald-600 font-medium">Updated</span> : <span className="text-slate-400">No info</span>}</div>
              </div>
            ...
            <div onClick={() => openEditor("Return & Refunds", KEYS.refunds, refunds)} className="px-4 py-3 cursor-pointer flex items-center">
              <div className="flex-1">
                ...
                <div className="text-sm mt-1">{refunds ? <span className="text-emerald-600 font-medium">Updated</span> : <span className="text-slate-400">No info</span>}</div>
              </div>
              <FaChevronRight className="text-slate-300" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm">
            <div onClick={() => openEditor("Payment Info", KEYS.payment, payment)} className="px-4 py-3 cursor-pointer flex items-center">
              <div className="flex-1">
                ...
                <div className="text-sm mt-1">{payment ? <span className="text-emerald-600 font-medium">Updated</span> : <span className="text-slate-400">No info</span>}</div>
              </div>
              <FaChevronRight className="text-slate-300" />
            </div>
            <div className="h-px bg-slate-100" />
            <div onClick={() => openEditor("Customer Service", KEYS.customerService, customerService)} className="px-4 py-3 cursor-pointer flex items-center">
              <div className="flex-1">
                ...
                <div className="text-sm mt-1">{customerService ? <span className="text-emerald-600 font-medium">Updated</span> : <span className="text-slate-400">No info</span>}</div>
              </div>
              <FaChevronRight className="text-slate-300" />
            </div>
            <div className="h-px bg-slate-100" />
            <div onClick={() => openEditor("Address Info", KEYS.address, address)} className="px-4 py-3 cursor-pointer flex items-center">
              <div className="flex-1">
                ...
                <div className="text-sm mt-1">{address ? <span className="text-emerald-600 font-medium">Updated</span> : <span className="text-slate-400">No info</span>}</div>
              </div>
              <FaChevronRight className="text-slate-300" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm">
            <div onClick={() => openEditor("Market Affiliation", KEYS.market, market)} className="px-4 py-3 cursor-pointer flex items-center">
              <div className="flex-1">
                ...
                <div className="text-sm mt-1">{market ? <span className="text-emerald-600 font-medium">Updated</span> : <span className="text-slate-400">No info</span>}</div>
              </div>
              <FaChevronRight className="text-slate-300" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm">
            <div onClick={() => openEditor("Promotional Sale", KEYS.promo, promo)} className="px-4 py-3 cursor-pointer flex items-center">
              <div className="flex-1">
                ...
                <div className="text-sm mt-1">{promo ? <span className="text-emerald-600 font-medium">Updated</span> : <span className="text-slate-400">No info</span>}</div>
              </div>
              <FaChevronRight className="text-slate-300" />
            </div>
            <div className="h-px bg-slate-100" />
            <div onClick={() => openEditor("Sales Discount", KEYS.discount, discount)} className="px-4 py-3 cursor-pointer flex items-center">
              <div className="flex-1">
                ...
                <div className="text-sm mt-1">{discount ? <span className="text-emerald-600 font-medium">Updated</span> : <span className="text-slate-400">No info</span>}</div>
              </div>
              <FaChevronRight className="text-slate-300" />
            </div>
          </div>
