                                ...
                                <>
                                    {isLoading ? (
                                        ...
                                        <div className="space-y-8">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex justify-between items-end px-1">
                                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Enter Amount (₦)</label>
                                                ...
                                                <div className="bg-slate-100 rounded-[1.8rem] overflow-hidden border-2 border-transparent focus-within:border-red-500/20 focus-within:bg-white transition">
                                                    <NumberInput
                                                        label="Amount"
                                            ...
                                            `}
                                                ...
                                                <p className="text-[10px] text-center font-black text-slate-400 uppercase tracking-widest">Funds arrive instantly via Paystack</p>
                                            </div>
                                        </div>
                                    ) : step === 2 ? (
                                        <div className="space-y-8 animate-in slide-in-from-right-4 duration-300">
                                            ...
                                            <div className="bg-slate-50 rounded-[2rem] p-8 border border-slate-100 space-y-6">
                                                ...
                                                <div className="flex justify-between items-start">
                                                    ...
                                                    <div className="text-right">
                                                        <p className="text-sm font-black text-slate-900">{account.bank_name}</p>
                                                        <p className="text-[11px] font-bold text-slate-500">{account.account_number}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="space-y-4">
                                                <div className="px-1">
                                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Enter Wallet PIN</label>
                                                </div>
                                                <input
                                                    type="password"
                                                    maxLength={4}
                                                    ...
                                                    placeholder="••••"
                                                    className="w-full bg-slate-100 border-2 border-transparent focus:border-emerald-500/20 focus:bg-white rounded-[1.5rem] px-6 py-5 text-center text-3xl font-black tracking-[0.5em] text-slate-900 placeholder:text-slate-300 transition outline-none"
                                                />
                                            </div>
