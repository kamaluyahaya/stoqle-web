...
const [country, setCountry] = useState("NG");
 ...
 useEffect(() => {
  ...
  async function handleSave() {
    ...
    setSaving(true);
    // const payloadObj = { address_line_1: trimmedLine1, address_line_2: trimmedLine2, city: address, state: address, country: "NG",postal_code:"8000029" };
    const payloadObj = {
  ...
  city: country,
    ...
    try {
      ...
      // optional UX hint
      // window.alert("Business address saved");
    } catch (e) {
  ...
  return (
    <div className="fixed inset-0 z-75 flex items-end sm:items-center justify-center" role="dialog" aria-modal="true">
      ...
      {/* Panel */}
        <div className="relative w-full max-w-2xl p-5 bg-white h-[75vh] sm:h-auto lg:rounded-2xl rounded-t-2xl shadow-xl z-10 flex flex-col">
