...
export default function CategorySelectionModal({
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {open && (
          <div className="fixed inset-0 z-75 flex items-end sm:items-center justify-center p-4" role="dialog" aria-modal="true">
            {/* Backdrop */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <motion.div
              ...
              className="relative w-full sm:w-[640px] max-h-[84vh] bg-white rounded-t-[0.5rem] sm:rounded-[0.5rem] overflow-hidden flex flex-col"
            >
              {/* Header */}
              ...
              {/* Footer: Actions */}
              <div className="bg-white px-4 py-4 pb-8 border-t border-slate-50">
