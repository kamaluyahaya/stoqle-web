              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`relative py-3 flex-1 text-sm font-bold whitespace-nowrap transition-all ${isActive ? "text-red-500" : "text-slate-400 hover:text-slate-600"
                      }`}
                  >
                    {tab.label}
                    {isActive && (
            ...
            {selectedUsers.length > 0 && (
              <div className="bg-white border-t border-slate-100 p-4 shrink-0 shadow-[0_-4px_20px_rgba(0,0,0,0.03)] z-10 flex flex-col gap-3">
                      ...
                      {selectedUsers.map((su, sIdx) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="absolute -top-1 -right-1 bg-white rounded-full text-slate-400 hover:text-red-500 shadow-sm border border-slate-100"
                          >
                ...
                <button
                  ...
                  className="w-full py-3 bg-red-500 disabled:bg-red-400 text-white rounded-full  shadow-lg shadow-red-500/30 active:scale-[0.98] transition-all flex items-center justify-center"
                >
                  {sending ? (
