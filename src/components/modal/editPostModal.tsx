        ...
        <div className="flex-1 overflow-y-auto no-scrollbar">
          <div className="flex flex-col h-full p-6 space-y-8">
            ...
            <div className="w-full relative group">
                    ...
                    <div className="absolute top-4 right-4 flex gap-2">
                      {mediaList.length > 1 && mediaList[index]?.id && (
                        <button
                          ...
                          className={`px-2 py-1 backdrop-blur-md rounded text-[10px] items-center gap-1 font-black  flex border transition-all ${coverId === mediaList[index]?.id || (!coverId && index === 0) ? "bg-red-500 text-white border-red-500" : "bg-black/40 text-white border-white/20 hover:bg-black/60"}`}
                        >
              ...
              <div className="mt-2 text-[10px] font-bold text-red-500  text-center px-4">
              ...
              {(Boolean(isBusiness) || Boolean((activeUser as any)?.business_id)) && (
                <div className="pt-2 space-y-3">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 rounded-full border transition-all active:scale-95 text-xs font-bold ${
                      selectedProduct
                        ? "bg-red-50 border-red-200 text-red-600 hover:bg-red-100"
                        : "bg-slate-50 border-slate-100 text-slate-500 hover:bg-slate-100"
                    }`}
                  >
                    <PlusIcon className={`w-3.5 h-3.5 ${selectedProduct ? "text-red-500" : "text-slate-400"}`} />
