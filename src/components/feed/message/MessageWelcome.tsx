    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 bg-gray-50 bg-chat-pattern transition-all animate-fadeIn">
            <div className="relative mb-6">
                <div className="w-24 h-24 bg-red-100 rounded-full flex items-center justify-center shadow-lg transform transition-transform hover:scale-110">
                    <svg
                ...
                <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-white border-2 border-red-500 rounded-full flex items-center justify-center animate-bounce shadow-md">
                    <span className="text-red-500 text-xs font-bold font-serif underline">S</span>
                </div>
            </div>

            <h2 className="text-2xl font-bold text-gray-900 mb-2 mt-4 text-center">
                Welcome to your <span className="text-red-500">Messages</span>
            </h2>
